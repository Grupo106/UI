...
<head>
	...
	<!-- Stylesheets
	============================================= -->
	<link rel="stylesheet" href="<?=base_url('public/css/fonts.css')?>" type="text/css"/>
...
<body class="stretched">
	...
	<script type="text/javascript" src="<?=base_url('public/js/components/timepicker.js')?>"></script>
